return {
	...
	keys = {
		...
		{ "]r", function() Snacks.words.jump(1) end, desc = "Jump to next reference", },
		{ "[r", function() Snacks.words.jump(-1) end, desc = "Jump to prev reference", },
		...
		{ "<leader>sb", function() Snacks.picker.lines() end, desc = "Lines" },
	...
	opts = {
		...
		dashboard = {
			enabled = true,
			sections = {
				{ icon = " ", title = "Keymaps", section = "keys", indent = 0, padding = 3, gap = 1 },
				{ icon = " ", title = "Projects", section = "projects", indent = 0, padding = 3 },
				{ section = "startup" },
				{ pane = 2, section = "header", indent = 4 },
			},
			preset = {
				header = [[
  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡰⢄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
